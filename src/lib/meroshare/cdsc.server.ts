...
export const CDSC_BASE = process.env["CDSC_BASE_URL"] ?? "https://webbackend.cdsc.com.np";
...
const CDSC_ORIGIN = process.env["CDSC_ORIGIN_URL"] ?? "https://meroshare.cdsc.com.np";
